"""
Base class for Robot Control Examples

Shared functionality for both MCP and FastMCP example scripts.
"""
...
class RobotExamplesBase:
    """Base class with common example implementations."""
    ...
    def __init__(self, client: Any):
        ...
        Args:
            client: Either RobotMCPClient or RobotFastMCPClient instance
        """
        self.client = client

    async def run_example(self, example_func: Callable, description: str):
...
EXAMPLE_MAP = {
    ...
    "boundary_placement": "Boundary Placement",
