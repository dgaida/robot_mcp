...
Usage:
    python examples_mcp_client.py [example_name]

Examples:
    python examples_mcp_client.py workspace_scan
    python examples_mcp_client.py sort_by_size
    python examples_mcp_client.py create_pattern
"""
...
class RobotExamples:
    ...
    async def object_swap(self):
        ...
        response = await self.client.chat(
            "Find the two largest objects and swap their positions"
        )
        print(f"🤖 Response: {response}")
